...
200 IF VPEEK(A+B*40)<>0 OR (VPEEK(A-1+B*40)=111 AND (VPEEK(A-2+B*40)=42 OR VPEEK(A-1+(B-1)*40)=42 OR VPEEK(A+(B-1)*40)=42)) GOTO 190 ELSE VPOKE A+B*40,42
210 NEXT X
350 F=0:N=0:P=0
